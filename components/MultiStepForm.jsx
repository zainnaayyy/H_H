      ...
      <footer className="bg-gray-100 py-6 mt-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm text-gray-600 mb-4">
            ...
            Reply HELP for help or STOP to cancel. Message and data rates may apply.
          </p>
          <div className="mb-4">
          <Dialog>
        ...
        <DialogContent className="sm:max-w-[800px] sm:max-h-[700px] overflow-y-auto">
          ...
          <p className="text-sm text-gray-600">
            ...
            from H4H Insurance. You can revoke your consent to receive emails at any 
            time by unsubscribing to emails at{' '}
            <a 
