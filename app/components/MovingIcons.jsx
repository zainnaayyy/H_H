...
const MovingIcons = () => {
  ...
  return (
    <div className='relative flex justify-center items-center bg-primary-gradient rounded-lg w-[90%] mx-auto my-10 overflow-hidden h-28 sm:h-32 md:h-36 lg:h-40 xl:h-44'>
      <motion.div className='absolute flex w-[200%]' animate={slideAnimation}>
        {/* Counter Section */}
        ...
        {/* Counter Section Duplicate for Continuous Animation */}
        <div className='flex flex-col items-center space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-5 w-[50%]'>
          <p className='text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white font-bold text-center'>
            Open Enrollment Begins November 1st...
          </p>
